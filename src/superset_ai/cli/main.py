...
def login() -> None:
    ...
    """
    from superset_ai.core.copilot_auth import CopilotAuthError, authenticate_copilot
...
def logout() -> None:
    ...
    """
    from superset_ai.core.copilot_auth import TOKEN_CACHE_PATH, clear_cached_token
